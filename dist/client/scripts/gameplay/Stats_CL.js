var Stats_CL = (function () {
    ...
    Stats_CL.prototype.importPacket = function (packet) {
        for (var key in packet) {
            this[key] = packet[key];
        }
    };
    Stats_CL.prototype.exportPacket = function () {
        return {
            deaths: this.deaths,
            kills: this.kills,
            dmgD: this.dmgD,
    ...
    Stats_CL.prototype.countHit = function (attackerPl, targetPl, healthBef, healthAft) {
