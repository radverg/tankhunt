...
var Tank_SE = (function (_super) {
    ...
    function Tank_SE(owner) {
        ...
        _this.maxHealth = 1500;
        _this.health = 1500;
        _this.armor = [0.8, 0.2, 0.05, 0.2];
        _this.owner = owner;
        _this.turret = new Turret();
        _this.maxSpeed = 3.3;
        _this.maxAngularVel = Math.PI / 2;
        _this.apcrGun = new Weapon_SE_1.Guns.APCRGun(owner);
        _this.specialGun = null;
        _this.bouncerGun = new Weapon_SE_1.Guns.BouncerGun(owner);
        return _this;
    }
    ...
    Tank_SE.prototype.getRearShotPosition = function (addDistance) {
        if (addDistance === void 0) { addDistance = 0; }
        var dist = this.body.hHeight + addDistance;
        return {
    ...
    Tank_SE.prototype.getTinyPacket = function () {
        var pack = {
    ...
    Tank_SE.prototype.stopCompletely = function () {
        this.stopRotation();
        _super.prototype.stop.call(this);
        this.turret.stopRotation();
    };
    Tank_SE.prototype.addHealth = function (amount) {
