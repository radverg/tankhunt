...
exports.Rect = exports.Vec2 = void 0;
...
var Rect = (function () {
    ...
    Rect.prototype.getClosestVertice = function (x, y) {
        ...
        for (var i = 1; i < this.vertices.length; i++) {
            if ((0, MyMath_SE_1.dist)(this.vertices[i].x, this.vertices[i].y, x, y) <
                (0, MyMath_SE_1.dist)(closest.x, closest.y, x, y)) {
    ...
    Rect.prototype.rotContains = function (x, y) {
        var ang = (0, MyMath_SE_1.getAngleToAxis)(this.cX, this.cY, x, y) - this.ang;
        var dis = (0, MyMath_SE_1.dist)(this.cX, this.cY, x, y);
    ...
    Rect.prototype.rectCircleVSCircle = function (x1, y1, r) {
        return (0, MyMath_SE_1.dist)(x1, y1, this.cX, this.cY) < this.hDiagonal + r;
    };
    Rect.prototype.simpleLineInt = function (x1, y1, x2, y2) {
        return ((0, MyMath_SE_1.checkIntersection)(x1, y1, x2, y2, this.left, this.top, this.right, this.top) ||
            (0, MyMath_SE_1.checkIntersection)(x1, y1, x2, y2, this.right, this.bottom, this.right, this.top) ||
            (0, MyMath_SE_1.checkIntersection)(x1, y1, x2, y2, this.left, this.bottom, this.right, this.bottom) ||
            (0, MyMath_SE_1.checkIntersection)(x1, y1, x2, y2, this.left, this.top, this.left, this.bottom));
    };
    Rect.prototype.lineInt = function (x1, y1, x2, y2) {
        return ((0, MyMath_SE_1.checkIntersection)(x1, y1, x2, y2, this.vertices[0].x, this.vertices[0].y, this.vertices[1].x, this.vertices[1].y) ||
            (0, MyMath_SE_1.checkIntersection)(x1, y1, x2, y2, this.vertices[1].x, this.vertices[1].y, this.vertices[2].x, this.vertices[2].y) ||
            (0, MyMath_SE_1.checkIntersection)(x1, y1, x2, y2, this.vertices[2].x, this.vertices[2].y, this.vertices[3].x, this.vertices[3].y) ||
            (0, MyMath_SE_1.checkIntersection)(x1, y1, x2, y2, this.vertices[0].x, this.vertices[0].y, this.vertices[3].x, this.vertices[3].y));
    };
    Rect.prototype.whichSideLineInt = function (startX, startY, endX, endY) {
        var side = -1;
        var closestX = null;
        var closestY = null;
        for (var i = 0; i < 4; i++) {
            var pt = (0, MyMath_SE_1.getLineIntPoint)(startX, startY, endX, endY, this.vertices[i].x, this.vertices[i].y, this.vertices[i + 1].x, this.vertices[i + 1].y);
            if (pt) {
                if (closestX === null && closestY === null) {
                    ...
                    if ((0, MyMath_SE_1.dist)(closestX, closestY, startX, startY) > (0, MyMath_SE_1.dist)(pt.x, pt.y, startX, startY)) {
                        closestX = pt.x;
                        closestY = pt.y;
                        side = i;
                    }
    ...
    Rect.prototype.lineIntPoints = function (x1, y1, x2, y2) {
        var points = [];
        var point = (0, MyMath_SE_1.getLineIntPoint)(x1, y1, x2, y2, this.vertices[0].x, this.vertices[0].y, this.vertices[1].x, this.vertices[1].y);
        if (point)
            points.push(point);
        point = (0, MyMath_SE_1.getLineIntPoint)(x1, y1, x2, y2, this.vertices[1].x, this.vertices[1].y, this.vertices[2].x, this.vertices[2].y);
        if (point)
            points.push(point);
        point = (0, MyMath_SE_1.getLineIntPoint)(x1, y1, x2, y2, this.vertices[2].x, this.vertices[2].y, this.vertices[3].x, this.vertices[3].y);
        if (point)
            points.push(point);
        point = (0, MyMath_SE_1.getLineIntPoint)(x1, y1, x2, y2, this.vertices[0].x, this.vertices[0].y, this.vertices[3].x, this.vertices[3].y);
        if (point)
            points.push(point);
        return points;
    };
    Rect.prototype.simpleLineIntPoints = function (x1, y1, x2, y2) {
        var points = [];
        var point = (0, MyMath_SE_1.getLineIntPoint)(x1, y1, x2, y2, this.left, this.top, this.right, this.top);
        if (point)
            points.push(point);
        point = (0, MyMath_SE_1.getLineIntPoint)(x1, y1, x2, y2, this.right, this.bottom, this.right, this.top);
        if (point)
            points.push(point);
        point = (0, MyMath_SE_1.getLineIntPoint)(x1, y1, x2, y2, this.left, this.bottom, this.right, this.bottom);
        if (point)
            points.push(point);
        point = (0, MyMath_SE_1.getLineIntPoint)(x1, y1, x2, y2, this.left, this.top, this.left, this.bottom);
        if (point)
            points.push(point);
        return points;
    };
    Rect.prototype.pointOverlapping = function (rect) {
        for (var i = 0; i < 4; i++) {
